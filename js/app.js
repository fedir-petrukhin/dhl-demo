...
.factory('reportService', ['$rootScope', function ($rootScope) {
    ...
    var service = {
        ...
        model: {
            ...
            date: new Date(),
            time: new Date(),
            name: "Harald Riis Thomsen",
            address: "Ermelundsvej 100, DS-28 20 Gentofte, Denmark",
            telephoneNumber: "+4524252525",
            vehicleNumber: "MM1718 XF",
            licenseNumber: "DNK12312312",
            imageTitle: "",
            gpsLocation: "",
            locationDescription: "",
            truckDamaged: false,
            goodsDamaged: false,
            goodsDamage: [{ type: "Broken" }],
            whereItHappend: "Inside truck"
        },
...
.controller('IdController', function($scope, $ionicModal, $cordovaDatePicker, $cordovaCamera, reportService, $cordovaSms, Complaint) {
    ...
    $scope.init = function() {
        ...
        $scope.report.incidentNumber = "DK" + nowDate.getFullYear() + $scope.pad(nowDate.getMonth() + 1, 2)
    ...
    $scope.sendReport = function() {
        ...
        var dto = {
            ...
            driverPassport: r.driverPassport,
            driverPassportPhoto: r.driverPassportPhoto,
            driverOther: r.driverOther,
            driverOtherPhoto: r.driverOtherPhoto,
            extraDriverName: r.extraDriverName,
            extraDriverAddress: r.extraDriverAddress,
            extraDriverTelephoneNumber: r.extraDriverTelephoneNumber,
            extraDriverLicenseNumber: r.extraDriverLicenseNumber,
            extraDriverLicensePhoto: r.extraDriverLicensePhoto,
            extraDriverPassport: r.extraDriverPassport,
            extraDriverPassportPhoto: r.extraDriverPassportPhoto,
            extraDriverOther: r.extraDriverOther,
            extraDriverOtherPhoto: r.extraDriverOtherPhoto,
